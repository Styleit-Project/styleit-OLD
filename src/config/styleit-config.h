/* src/config/styleit-config.h.  Generated from styleit-config.h.in by configure.  */
/* src/config/styleit-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.styleit.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Styleit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Styleit Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "styleit"
