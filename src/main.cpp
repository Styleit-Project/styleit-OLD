...
#if defined(NDEBUG)
#error "Styleit cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < 1) {
    ...
    } else if (nHeight >= 1 && nHeight < 1601) {
        nSubsidy = 10000 * COIN;  
	} else if (nHeight >= 1601 && nHeight < 10000) {
		nSubsidy = 20 * COIN;  
		...
		nSubsidy = 100 * COIN; 
	} else if (nHeight >= 160000 && nHeight < 419200) {
		nSubsidy = 50 * COIN;
	} else if (nHeight >= 419200 && nHeight < 953200) {
		nSubsidy = 25 * COIN;
...
int ActiveProtocol()
{
   if (IsSporkActive(SPORK_14_NEW_PROTOCOL_ENFORCEMENT) || chainActive.Tip()->nHeight > 26000) {
