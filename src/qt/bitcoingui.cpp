                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Styleit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Styleit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and styleit: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Styleit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Styleit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Styleit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Styleit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Styleit addresses"));
    ...
    openAction->setStatusTip(tr("Open a Styleit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Styleit Core help message to get a list with possible Styleit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Styleit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Styleit network", "", count));
}
...
{
    QString strTitle = tr("Styleit Core"); // default title
