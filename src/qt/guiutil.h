...
/** Utility functions used by the Styleit Qt UI.
 */
namespace GUIUtil
{
...
// Render Styleit addresses in monospace font
...
// Parse "styleit:" URI into recipient object, return true on successful parsing
