...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Styleit Core styleit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  styleit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded styleit transaction") + "\n" +
                               "  styleit-tx [options] -create [commands]   " + _("Create hex-encoded styleit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded styleit transaction
