...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Styleit server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Styleit features */
        {"styleit", "masternode", &masternode, true, true, false},
        {"styleit", "masternodelist", &masternodelist, true, true, false},
        {"styleit", "mnbudget", &mnbudget, true, true, false},
        {"styleit", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"styleit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"styleit", "mnsync", &mnsync, true, true, false},
        {"styleit", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"styleit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use styleitd, or the -server option to styleit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> styleit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15120/\n";
}
