Contributing to Styleit Core
============================

The Styleit Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Styleit Core project, and is not to be
confused with overall Styleit Network Protocol consensus changes.

Whether a pull request is merged into Styleit Core rests with the project merge
...
Patches that change Styleit consensus rules are considerably more involved than
...
Where a patch set proposes to change the Styleit consensus, it must have been
...
The project leader is the release manager for each Styleit Core release.
