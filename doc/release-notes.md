Styleit Core version 2.2.1 is now available from:

  <https://github.com/styleittoken/styleit/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/styleittoken/styleit/issues>

Compatibility
==============

Styleit Core is extensively tested on multiple operating systems using
...
Styleit Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Styleit was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/styleit-project-translations/).
