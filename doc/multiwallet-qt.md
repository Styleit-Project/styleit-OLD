...
In order to support loading of multiple wallets in styleit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is styleit.cpp.
...
Changes to styleit.cpp
----------------------
styleit.cpp is the entry point into styleit-qt, and as such, will require some minor modifications to provide hooks for
