...
RESOURCES += src/qt/styleit.qrc src/qt/styleit_locale.qrc

TRANSLATIONS += src/qt/locale/styleit_bg.ts \
                src/qt/locale/styleit_ca.ts \
                src/qt/locale/styleit_cs.ts \
                src/qt/locale/styleit_da.ts \
                src/qt/locale/styleit_de.ts \
                src/qt/locale/styleit_en.ts \
                src/qt/locale/styleit_es.ts \
                src/qt/locale/styleit_fi.ts \
                src/qt/locale/styleit_fr_FR.ts \
                src/qt/locale/styleit_it.ts \
                src/qt/locale/styleit_ja.ts \
                src/qt/locale/styleit_ko_KR.ts \
                src/qt/locale/styleit_nl.ts \
                src/qt/locale/styleit_pl.ts \
                src/qt/locale/styleit_pt_BR.ts \
                src/qt/locale/styleit_pt.ts \
                src/qt/locale/styleit_ro_RO.ts \
                src/qt/locale/styleit_ru.ts \
                src/qt/locale/styleit_sk.ts \
                src/qt/locale/styleit_sv.ts \
                src/qt/locale/styleit_zh_CN.ts \
                src/qt/locale/styleit_zh_TW.ts
